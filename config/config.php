...
session_start();
$base_url = 'https://vuarobux.com/'; // Thay url web bạn
class CMSNT
{
    private $ketnoi;
    function connect()
    {
        if (!$this->ketnoi)
        {
            $this->ketnoi = mysqli_connect('localhost', 'vuarobu1_xx', 'vuarobu1_xx', 'vuarobu1_xx') or die ('Vui lòng kết nối đến DATABASE');
