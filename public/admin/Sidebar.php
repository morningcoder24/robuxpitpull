                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="<?=BASE_URL('public/admin/DonHangCayThue.php');?>" class="nav-link">
                                ...
                                <p>
                                    Đơn Hàng GP RB  <span class="badge badge-info right"><?=$CMSNT->num_rows("SELECT * FROM `orders_caythue` WHERE `status` = 'xuly' ");?></span>
                                </p>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?=BASE_URL('Admin/SettingBang');?>" class="nav-link">
                                <i class="nav-icon fas fa-cog"></i>
                                <p>
                                    Cấu Hình Bảng
                                </p>
