...
<div class="w-full max-w-6xl mx-auto pt-6 md:pt-8 pb-8">
    <div class="grid grid-cols-8 gap-4 md:p-4 cmsnav-contain">
                    ...
                    <div class="py-2 overflow-x-auto scrolling-touch max-w-400">
                        <table id="datatable" class="table-auto w-full scrolling-touch min-w-850">
                            ...
                            <tbody class="text-sm font-semibold">
                                ...
                                <tr>
                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b"><?=$i++;?></td>
                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b"><?=$accounts['id'];?></td>
                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b"><?=$groups['title'];?></td>
                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b"><?=$category['title'];?></td>
                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b"><?=explode("|", $accounts['account'])[0];?></td>
                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b"><?=explode("|", $accounts['account'])[1];?></td>
                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b"><?=explode("|", $accounts['account'])[2];?></td>
                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b">
                                        <?=format_cash($accounts['money']);?> VNĐ</td>

                                    <td class="text-sm text-white-800 text-left px-1 py-1 border-b"><span
